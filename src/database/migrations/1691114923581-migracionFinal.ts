...
export class MigracionFinal1691114923581 implements MigrationInterface {
    name = 'MigracionFinal1691114923581'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "empresa" ("rfc" character varying(13) NOT NULL, "ingresoMensual" character varying(255) NOT NULL, "antiguedad" character varying(255) NOT NULL, "tipoGiro" character varying(255) NOT NULL, "gasto" character varying(255) NOT NULL, "percepcionMensual" character varying(255) NOT NULL, "utilidad" character varying(255) NOT NULL, "empresaTipo" character varying(255) NOT NULL, "beneficiarioId" integer, "representanteLegalCurp" character varying(18), CONSTRAINT "REL_b3153b406fe61288c26ab2a815" UNIQUE ("beneficiarioId"), CONSTRAINT "PK_050fffc050c015802aced7e33cd" PRIMARY KEY ("rfc"))`);
        ...
        await queryRunner.query(`CREATE TABLE "transaccion" ("id" SERIAL NOT NULL, "monto" integer NOT NULL, "descripcion" character varying(255) NOT NULL, "fecha" date NOT NULL DEFAULT ('now'::text)::date, "beneficiarioEmisorId" integer, "beneficiarioReceptorId" integer, CONSTRAINT "PK_1d7fb1e642fb44d52a2fce77fc6" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "beneficiario" ("id" SERIAL NOT NULL, "nombre" character varying(255) NOT NULL, "correo" character varying(255) NOT NULL, "contrasenia" character varying(255) NOT NULL, "foto" character varying(255), "saldo" integer, "domicilioId" integer, CONSTRAINT "PK_9e84e9c9d884399c3ad68d51c8b" PRIMARY KEY ("id"))`);
